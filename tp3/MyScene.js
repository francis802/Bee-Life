...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.cylinder = new MyCylinder(this, 50, 20);

        this.objects = [this.plane, this.pyramid, this.cone, this.cube, this.tangram, this.prism, this.cylinder];

        // Labels and ID's for object selection on MyInterface
        this.objectIDs = { 'Plane': 0 , 'Pyramid': 1, 'Cone': 2, 'Cube': 3, 'Tangram': 4, 'Prism': 5, 'Cylinder': 6};
